...
import { submitInventory } from '@/api/submission'
...
const onSubmit = async () => {
  ...
  try {
    await submitInventory(form.value.commodityId, form.value.amount)
    ElMessage.success('库存提交成功')
